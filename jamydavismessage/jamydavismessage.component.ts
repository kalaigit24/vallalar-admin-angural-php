...
export class JamydavismessageComponent implements OnInit {
...
export class JamyMessageForm {
  ...
  admin_id=2;
  constructor(
    public dialogRef: MatDialogRef<JamyMessageForm>,
...
export class JamyVideoForm {
  ...
  admin_id=2;
  constructor(
    public dialogRef: MatDialogRef<JamyVideoForm>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private _snackBar: MatSnackBar,
    private httpClient: HttpClient) {
...
export class JamyAudioForm {
  ...
  admin_id=2;
  constructor(
    public dialogRef: MatDialogRef<JamyAudioForm>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private _snackBar: MatSnackBar,
    private httpClient: HttpClient) {
...
export class JamyPictureViewAboutMessage {
  image_url: string = 'http://vallalarforall.com/vallalar_app_api/v1/';
  action: string = '';
  loading = false;
  ...
  data: any;
  constructor(
    public dialogRef: MatDialogRef<JamyPictureViewAboutMessage>,
...
export class JamyPictureViewAboutAudio {
  image_url: string = 'http://vallalarforall.com/vallalar_app_api/v1/';
  action: string = '';
  loading = false;
  student_register_id = 0;
  data: any;
  constructor(
    public dialogRef: MatDialogRef<JamyPictureViewAboutAudio>,
    @Inject(MAT_DIALOG_DATA) public datapopup: any,
    private _snackBar: MatSnackBar,
    private httpClient: HttpClient) {
    if (this.datapopup != null) {
